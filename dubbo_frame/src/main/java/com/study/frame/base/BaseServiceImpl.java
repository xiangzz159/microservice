package com.study.frame.base;

import com.github.pagehelper.PageHelper;
import com.study.frame.db.DataSourceEnum;
import com.study.frame.db.DynamicDataSource;
import com.study.frame.util.SpringContextUtil;
...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService {
    ...
    @Override
    public List<Record> selectByExampleWithBLOBs(Object example) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
    ...
    @Override
    public List<Record> selectByExample(Object example) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
    ...
    @Override
    public List<Record> selectByExampleWithBLOBsForStartPage(Object example, Integer pageNum, Integer pageSize) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
            Method selectByExampleWithBLOBs = mapper.getClass().getDeclaredMethod("selectByExampleWithBLOBs", example.getClass());
    ...
    @Override
    public List<Record> selectByExampleForStartPage(Object example, Integer pageNum, Integer pageSize) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
            Method selectByExample = mapper.getClass().getDeclaredMethod("selectByExample", example.getClass());
            PageHelper.startPage(pageNum, pageSize, false);
    ...
    @Override
    public List<Record> selectByExampleWithBLOBsForOffsetPage(Object example, Integer offset, Integer limit) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
            Method selectByExampleWithBLOBs = mapper.getClass().getDeclaredMethod("selectByExampleWithBLOBs", example.getClass());
    ...
    @Override
    public List<Record> selectByExampleForOffsetPage(Object example, Integer offset, Integer limit) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
            Method selectByExample = mapper.getClass().getDeclaredMethod("selectByExample", example.getClass());
            PageHelper.offsetPage(offset, limit, false);
    ...
    @Override
    public Record selectFirstByExample(Object example) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
            Method selectByExample = mapper.getClass().getDeclaredMethod("selectByExample", example.getClass());
    ...
    @Override
    public Record selectFirstByExampleWithBLOBs(Object example) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.SLAVE.getName());
            Method selectByExampleWithBLOBs = mapper.getClass().getDeclaredMethod("selectByExampleWithBLOBs", example.getClass());
    ...
    @Override
    public int updateByExampleWithBLOBs(@Param("record") Object record, @Param("example") Object example) {
        try {
            DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
